...
class AssessmentService:
    ...
    def greeting(self):
        return [
            ...
            ChatMessage.assistant("Não existem respostas certas ou erradas. O mais importante é responder com sinceridade, de acordo com como você realmente tem se sentido."),
